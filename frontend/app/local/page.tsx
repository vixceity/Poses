  ...
  return (
    <main className="poses-screen flex min-h-dvh flex-col gap-3 p-3 lg:h-dvh lg:min-h-0 lg:overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-between gap-2 sm:flex-row lg:hidden">
        <FailureWord litCount={game.letters[0]} active={game.spotlight === 0} playerLabel="P1" orientation="horizontal" />
        <FailureWord litCount={game.letters[1]} active={game.spotlight === 1} playerLabel="P2" orientation="horizontal" />
      </div>
